...
bird_downflap = pygame.image.load('assets/bluebird-downflap.png').convert().convert_alpha()
bird_midflap = pygame.image.load('assets/bluebird-midflap.png').convert().convert_alpha()
bird_upflap = pygame.image.load('assets/bluebird-upflap.png').convert().convert_alpha()
